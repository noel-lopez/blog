...
It's worth noting that nowadays, many developers don't differentiate between the different kind of test doubles and simply refer to all of them as "mocks". 

This is largely due to the prevalence of mocking libraries, which provide powerful tools that can serve as dummies, stubs, spies, or mocks depending on the way you use them.

In the future, I plan to write another post about how to use some of my favorite mocking libraries with practical examples. Stay tuned!